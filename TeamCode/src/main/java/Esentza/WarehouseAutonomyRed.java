...
@Config
@Autonomous(name = "Autonomie Rosu Warehouse", group = "Autonomii Esentza")
public class WarehouseAutonomyRed extends LinearOpMode {
   ...
   public static double LEVEL1_DISTANCE = 5.5;
   ...
   public void runOpMode() {
      ...
      drive.setPoseEstimate(new Pose2d(10, -62, Math.toRadians(180)));

      TrajectorySequence trajectory0 = drive.trajectorySequenceBuilder(new Pose2d(10, -62, Math.toRadians(180)))
              .addDisplacementMarker(() -> liftEnum = LIFT_ENUM.UP)
              .forward(10)
              .lineToLinearHeading(new Pose2d(-13, -41, Math.toRadians(-90)))
              .addDisplacementMarker(15, ()->lift.setArmPosition(ARM_POSITION_OPEN))
              .build();
      ...
      TrajectorySequence trajectory1 = drive.trajectorySequenceBuilder(trajectory0.end())
              ...
              .lineTo(new Vector2d(45, -62), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
      ...
      TrajectorySequence trajectory3 = drive.trajectorySequenceBuilder(trajectory2.end())
              ...
              .lineTo(new Vector2d(46, -62), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                      SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
              .build();

      TrajectorySequence trajectory4 = drive.trajectorySequenceBuilder(trajectory3.end())
              .lineTo(new Vector2d(8, -62))
              .addDisplacementMarker(6, ()->
              {
                 intakeEnum = INTAKE_ENUM.REVERSE;
                 lift.setArmPosition(ARM_POSITION_OPEN);
      ...
      TrajectorySequence trajectory5 = drive.trajectorySequenceBuilder(trajectory4.end())
              ...
              .lineTo(new Vector2d(47, -62), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                      SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
              .build();

      TrajectorySequence trajectory6 = drive.trajectorySequenceBuilder(trajectory5.end())
              .lineTo(new Vector2d(8, -65), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                      SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
              .addDisplacementMarker(6, ()->
              {
                 intakeEnum = INTAKE_ENUM.REVERSE;
      ...
      TrajectorySequence trajectory7 = drive.trajectorySequenceBuilder(trajectory6.end())
              ...
              .splineTo(new Vector2d(10, -62), Math.toRadians(0))
              .addDisplacementMarker(20, ()->
              {
                 LIFT_DISTANCE = 0;
                 liftEnum = LIFT_ENUM.DOWN;
              ...
              .forward(36, SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                      SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
              .build();

      TrajectorySequence trajectory8 = drive.trajectorySequenceBuilder(trajectory7.end())
              .back(38, SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                      SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
              .addDisplacementMarker(6, ()->
              {
                 intakeEnum = INTAKE_ENUM.REVERSE;
              ...
              .splineTo(new Vector2d(-8, -41), Math.toRadians(-90))
              .build();

      TrajectorySequence trajectory9 = drive.trajectorySequenceBuilder(trajectory6.end())
              .addDisplacementMarker(1, ()->
              {
                 lift.setClawPosition(CLAW_POSITION_CLOSED);
                 lift.setArmPosition(ARM_POSITION_CLOSED);
